...
const benefits = [
  ...
  { icon: ShoppingBag, title: "Pedido por WhatsApp", detail: "Armás el carrito y lo enviás, sin registrarte" },
]

export function BenefitsBar() {
  return (
    <section aria-label="Cómo comprar" className="max-w-[1400px] mx-auto px-4 pt-4">
