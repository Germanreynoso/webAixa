...
// Fotos reales del catálogo para el mosaico de "Nuestra Historia" (3 columnas).
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <div className="order-1 lg:order-2 relative animate-in fade-in slide-in-from-right duration-1000">
            {/* Mosaico de marca: productos reales del catálogo, sin personas */}
            <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden border border-border/50 shadow-2xl gradient-hero-vibrant">
              <img
