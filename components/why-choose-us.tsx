...
export function WhyChooseUs() {
  return (
    <section id="nosotros" className="py-20 sm:py-28 bg-background">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            <div className="aspect-square rounded-3xl bg-gradient-to-br from-primary/20 to-secondary/20 overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-white">El Grow de Aixa</p>
            ...
            <div className="absolute -top-6 -right-6 bg-card rounded-2xl shadow-xl p-6 border border-border">
